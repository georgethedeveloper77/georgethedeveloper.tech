        ...
        <ul class="d-none d-lg-flex m-0">
            <li class="social-icons d-flex align-items-center">
                ...
                foreach($social_links as $key){
                    ...
                    echo '<a hef="'.$key->text.'" class="css3animate p-0" title="'.ucfirst($title[0]).'" data-bs-toggle="tooltip" data-bs-placement="bottom"><i class="'.$key->title.'"></i></a>';
                }
                @endphp
            </li>
        </ul>
    ...
    <ul class="w-100 py-3 px-0">
        ...
        @if (!empty($general->social_links) && ($general->social_links != '[]'))
            <li class="py-3 text-end social-icons">
                ...
                foreach($social_links as $key){
                    $title = explode("-",substr($key->title, 7));
                    echo '<a class="mx-3" hef="'.$key->text.'" class="css3animate p-0" title="'.ucfirst($title[0]).'" data-bs-toggle="tooltip" data-bs-placement="bottom"><i class="'.$key->title.'"></i></a>';
                }
                @endphp
            </li>
        @endif
