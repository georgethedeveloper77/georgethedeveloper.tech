...
<head>
    ...
    <!-- FAVICONS -->
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="{{ url('/') }}/demo/img/general/favicon/apple-touch-icon-152x152-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ url('/') }}/demo/img/general/favicon/apple-touch-icon-144x144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="120x120" href="{{ url('/') }}/demo/img/general/favicon/apple-touch-icon-120×120-precomposed.png	">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ url('/') }}/demo/img/general/favicon/apple-touch-icon-114x114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="76x76" href="{{ url('/') }}/demo/img/general/favicon/apple-touch-icon-76×76-precomposed.png	">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ url('/') }}/demo/img/general/favicon/apple-touch-icon-72x72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="{{ url('/') }}/demo/img/general/favicon/apple-touch-icon-57x57-precomposed.png">
    <link rel="shortcut icon" href="{{ url('/') }}/demo/img/general/favicon/favicon.png">
    @endif
